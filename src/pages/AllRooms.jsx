        ...
        <div>
          <div className='flex flex-col items-start text-left'>
            ...
            <p className='text-sm md:text-base text-gray-500/90 mt-2 max-w-174'>
              ...
              special packages to enhance your stay and create unforgettable memories.</p>
          </div>
          
          {roomsDummyData.map((room)=>(
            <div key={room._id} className='mt-8'>
               ...
               <div className='md:w-1/2 flex flex-col gap-2'>
                ...
                <div className='mt-2'>
                  <p className='text-lg font-semibold text-green-600'>${room.pricePerNight}/night</p>
